...
class ElementaryLevelResource extends JsonResource
{
    /**
    ...
    private function forList(): array
    {
        ...
        return [
            'id' => $this->id,
            'uuid' => $this->uuid,
            'capability_domain' => $this->capabilityDomain,
            ...
            'status' => $this->status ? ElementaryLevelStatus::get($this->status, $currentLang) : null,
            'state' => $this->state ? ElementaryLevelState::get($this->state, $currentLang) : null,
        ];
    }
    ...
    private function forView(): array
    {
        ...
        return [
            ...
            'budget' => $this->budget,
            'currency' => $this->currency,
            'capability_domain' => $this->capabilityDomain ? $this->capabilityDomain->name : null,
