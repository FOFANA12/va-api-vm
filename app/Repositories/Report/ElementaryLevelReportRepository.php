...
{
    public function getGlobalReport(ElementaryLevel $elementaryLevel): array
    {
        return $this->buildReport($elementaryLevel);
    }

    private function buildReport(ElementaryLevel $elementaryLevel): array
    {
        // ACTIONS
        $actions = Action::where('elementary_level_uuid', $elementaryLevel->uuid)->get();
        ...
        $expenseTypes = DB::table('action_fund_disbursement_expense_types as afdet')
            ...
            ->where('a.elementary_level_uuid', $elementaryLevel->uuid)
