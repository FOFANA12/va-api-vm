...
class Project extends Model
{
    ...
    {
        return $this->belongsToMany(Beneficiary::class, 'project_beneficiaries', 'project_uuid', 'beneficiary_uuid', 'uuid', 'uuid');
    }

    public function fundingSources(): BelongsToMany
    {
        return $this->belongsToMany(FundingSource::class, 'project_funding_sources', 'project_uuid', 'funding_source_uuid', 'uuid', 'uuid')
            ->withPivot('planned_budget');
    }

    public function statuses(): HasMany
    {
        return $this->hasMany(ProjectStatus::class, 'project_uuid', 'uuid');
    }

    public function states(): HasMany
    {
        return $this->hasMany(ProjectState::class, 'project_uuid', 'uuid');
    }
